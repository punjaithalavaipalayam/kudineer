  ...
  el.innerHTML = `
    ...
    <div class="table-wrapper">
      <table class="data-table">
        <thead>
          <tr><th rowspan="2" class="cs box-date-start">S.No</th><th rowspan="2" class="cd box-date-end">Month</th><th colspan="${c1.length}" class="gh col-group-138">CWSS-138 (Avg Litres)</th><th colspan="${c2.length}" class="gh2 col-group-238">CWSS-238 (Avg Litres)</th></tr>
