  ...
  el.innerHTML = `
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:10px; margin-bottom:18px">
      ...
      <div style="background:linear-gradient(135deg,#3b0764,#7c3aed); border-radius:12px; padding:14px 10px; color:#fff; text-align:center">
        ...
        <div style="font-size:1.8rem; font-weight:900; color:${Math.round(((avgDaily138 + avgDaily238) / (TARGET_138 + TARGET_238)) * 100) >= 100 ? '#86efac' : Math.round(((avgDaily138 + avgDaily238) / (TARGET_138 + TARGET_238)) * 100) >= 75 ? '#fde68a' : Math.round(((avgDaily138 + avgDaily238) / (TARGET_138 + TARGET_238)) * 100) >= 50 ? '#fdba74' : '#fca5a5'}">${(avgDaily138 + avgDaily238) > 0 ? Math.round(((avgDaily138 + avgDaily238) / (TARGET_138 + TARGET_238)) * 100) : 0}%</div>
      </div>
    </div>
